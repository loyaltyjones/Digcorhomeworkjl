...
function Story4() {
  ...
  return (
    <>
      {/* Using a conditional ternary operator if fading is false our classname will be only level4body, if fading is true our classname will be fade-out initializing our animation */}
